...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
    url: "https://www.luigiofficialbrand.com/og-images/blog-luigi-series-6-flavors-guide-2026.jpg",
        width: 1200,
        height: 630,
  ...
  twitter: { card: "summary_large_image", images: ["https://www.luigiofficialbrand.com/og-images/blog-luigi-series-6-flavors-guide-2026.jpg"] },
  alternates: {
      ...
      <main className="min-h-screen bg-white">
        ...
        <section className="relative pt-24 pb-8 md:pt-32 md:pb-12 bg-black overflow-hidden">
          <div 
            ...
            style={{ backgroundImage: "url('https://hebbkx1anhila5yf.public.blob.vercel-storage.com/FATTONE_PINEAPPLE-DIESEL-2400x2400-3keIPfmE7xCxtLaGAIli3SvtPx6Zin.jpg')" }}
          />
