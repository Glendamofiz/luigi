...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const aioProducts = ['acapulco-gold-aio-dual-pack', 'bubblegum-kush-aio-dual-pack', 'bullet-trainwreck-aio-dual-pack'].map((slug) => ({ url: `${baseUrl}/products/${slug}`, lastModified, changeFrequency: 'weekly' as const, priority: 0.85 }))
