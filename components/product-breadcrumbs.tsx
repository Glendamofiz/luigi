...
export function ProductBreadcrumbs({ productName }: { productName: string }) {
  return (
    <>
      ...
      <span className="px-2">&gt;</span>
      <Link href="https://www.luigiofficialbrand.com/products/gummies" className="hover:text-black">Gummies</Link>
      <span className="px-2">&gt;</span>
